...
flg_analysis_mode = 1;                % CANape(1), DDRS(2), SHRP2(3), MEISTER(4); GIKEN(5)
flg_50k           = 0;                % Flag to run the dataset for 50k trip files
flg_all           = 0;                % Flag to run all dataset
flg_cctime        = 0;
mode_acc          = 1;                % Flag to turn on wiedemann ACC partition (0: evaluate all, 1: evaluate only ACC)
...
clear i_mt_plot k imdata flg_time_interp
clear flg_mtn sz 
