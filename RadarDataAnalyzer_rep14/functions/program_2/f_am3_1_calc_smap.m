function M_data_fq = f_am3_1_calc_smap(vsp_min,         vsp_step,        vsp_max,      dvsp_step,   ...
                                       ...
                                       out_dectime)
%% Åò4-1-3-2-9 Generate frequency plots
%% Åò4-1-3-2-9-1 Plot sequence for frequency distribution maps
    M_data_fq = f_am3_1_1_set_fieldnames(1);
    i_mt = 1;
%% Åò4-1-3-2-9-2 Define variables to store in structure (Need to input: max, min, step-size)
...
%% Åò4-1-3-2-9-3 Construct Speed Acceleration Frequency Map
