function out_mileage_mt = f_am3_1_calc_mileage_mt(vsp, dt)
%% ˜4-1-3-2-4 Calculates distance travelled per microtrip

%% ˜4-1-3-2-4-1 Initializing parameters
...
%% ˜4-1-3-2-4-2 Determining speed states 
    for i=1:length(vsp)
        if vsp(i) > 0
...
%% ˜4-1-3-2-4-3 Determining edge changes (Detect speed inflection states when vsp_state==1)
 ...
 %% ˜4-1-3-2-4-4 Calculate distance travelled
