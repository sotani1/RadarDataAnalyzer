function [ind_ftype ind_ftarget ind_fvar  ind_filv] = ff_set_mindx(f_type, f_target, f_var, f_ilv, M_data)
...
%% Key ====================================================================
 ...
 % f_var    = 'posx';
 % f_ilv    = 'non_ilv';
 % Example: M_data(1).type(ind_ftype).target(ind_ftarget).variable(ind_fvar).data = 5;
%% ========================================================================
